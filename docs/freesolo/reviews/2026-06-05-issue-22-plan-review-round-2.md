...
- Loader Public API, both spawn integration points, starter files, no-cache reads, and injectable deps match the spec. ADR-0001 already documents `.freesolo/knowledge/*.md`; no plan task needed.
