...
| 8 | `getIssueReportsDir` relative-path join | Task 4 Step 3 shows full `gitFreesoloPath` with `path.join(repoRoot, resolved)` and explicit “mirror verification store” note. |
