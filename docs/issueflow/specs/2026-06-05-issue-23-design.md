...
**Issue:** [#23 — Agent Event Log](https://github.com/robert-gleis/issueflow/issues/23)
...
- **CLI surface (`issueflow events …`).** Out of scope; consumers call the module directly. A CLI can follow later.
